...
Before you start solving the exercises, let's kill two birds with one stone and familiarizing with git while solving the exercises. You want to solve the exercises on a new branch. Once you verified that your solutions are correct, you will merge the branch to your master.
...
see how branching works. Commit everything up to year and create a new branch called `solutions` to solve the exercises. Once your are done, you will merge `solutions` to your `master`.
...
Respond to the following questions and push the responses to your GitHub:
 ...
 - Create another vector `age` with your family members' ages (using `birth`)
 - Use `typeof()` to make sure that they are of the appropriate types
