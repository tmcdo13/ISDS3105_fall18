...
We worked on a map of alcohol consumption for beer, spirits, and wine. Create a parametrized report for each type of serving using parameters to render dynamically:
