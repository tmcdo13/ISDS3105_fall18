...
ggplot() + geom_line(data = twitter_users, aes(x = Year, y = millions),color = 'blue') + geom_point(data = twitter_users, aes(x = Year, y = millions, fill = Year))
```
...
ggplot() + geom_line(data = twitter_users, aes(x = Year, y = millions),color = 'blue') + geom_line(data = fbMobile_users, aes(x = Year, y = millions),color = 'red')
```
...
```{r}
myBirthYear <- c(1997)
ggplot() + geom_line(data = beerDt, aes(x = Year, y = GallonsCapita),color = 'blue') + geom_point(data = myBirthYear, aes(x = Year, y = GallonsCapita, fill(year)))
```
