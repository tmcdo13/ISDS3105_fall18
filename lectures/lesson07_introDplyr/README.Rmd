...
<<<<<<< HEAD
titanicDt %>%
  filter(Sex == 'Female', Age == 'Child', Survived == 'No')
=======

>>>>>>> 0e31ce146d396c53753248b3d2c60643bd2db790
```
...
<<<<<<< HEAD
untidyReview %>%
  mutate(reviewStayYear = as.numeric(reviewStayYear))
=======
...
<<<<<<< HEAD
#flights %>%
#full_join(airlines, c('carrier' = 'carrier'))
#glimpse(flights)
full_join(flights, airlines)
glimpse(flights)
=======
