...
We want to plot the correlation between insurance_premiums and losses
...
Although for tasks like the above is easier to functionally execute the dplyr verbs we already familiarized with:
